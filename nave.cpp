...
cci.dwSize=50;//tamaño de cursor
cci.bVisible=FALSE;
...
void NAVE::pintar()
{
	...
	gotoxy(x,y+1);printf("  %c%c%c",40,206,41);
	gotoxy(x,y+2);printf("%c%c   %c%c",60,205,205,62);
}
...
{
	gotoxy(55,2);printf("VIDAS %d",vidas);
...
int main()
{
	...
	while(!game_over)
	{
	gotoxy(15,2);printf("disp con a, muevete con las felchas");
